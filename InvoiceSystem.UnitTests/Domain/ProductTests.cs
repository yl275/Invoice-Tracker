...
namespace InvoiceSystem.UnitTests.Domain
{
    public class ProductTests
    {
        ...
        {
            Action act = () => new Product(TestData.TestTeamId, TestData.UserId, "Name", "SKU", 0m);
        ...
        {
            var product = new Product(TestData.TestTeamId, TestData.UserId, "Old Name", "Old SKU", 10m);
